    ...
    <form onSubmit={handleSubmit} className="myform2">
      ...
      <style jsx>{`
        ...
        .container {
          ...
          background:linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(91,91,193,1) 35%, rgba(0,212,255,1) 100%), url("https://images.pexels.com/photos/66284/winter-nature-season-trees-66284.jpeg?crop=entropy&cs=srgb&dl=pexels-pixabay-66284.jpg&fit=crop&fm=jpg&h=1317&w=1920");
