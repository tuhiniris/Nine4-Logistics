    ...
    <form onSubmit={handleSubmit} className="myform2">
      ...
      <style jsx>{`
        ...
        .container {
          ...
          background:linear-gradient(0deg, rgba(155, 1, 1, 0.3), rgba(189, 0, 255, 0.3)), url("https://images.pexels.com/photos/66284/winter-nature-season-trees-66284.jpeg?crop=entropy&cs=srgb&dl=pexels-pixabay-66284.jpg&fit=crop&fm=jpg&h=1317&w=1920");
