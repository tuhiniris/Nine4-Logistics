    ...
    <form onSubmit={handleSubmit} className="myform2">
      ...
      <style jsx>{`
        ...
        .container {
          ...
          background:linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(91,91,193,0) 9%, rgba(63,129,213,0.7847514005602241) 47%, rgba(49,147,222,1) 65%, rgba(0,212,255,0.4906337535014006) 79%), url("https://images.pexels.com/photos/66284/winter-nature-season-trees-66284.jpeg?crop=entropy&cs=srgb&dl=pexels-pixabay-66284.jpg&fit=crop&fm=jpg&h=1317&w=1920");
